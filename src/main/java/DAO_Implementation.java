...
public class DAO_Implementation implements DAOInterface{
    ...
    public void add(Category cat) throws ClassNotFoundException,SQLException{
        ...
        query.setString(1,cat.getCatecode());
        query.setString(2, cat.getCatdesc());

        query.executeUpdate();

        System.out.printf("One record added");
    }

    @Override
    public Category edit(Category cat, String ccat) throws SQLException,ClassNotFoundException{
        PreparedStatement query;
        query = con3.connect().prepareStatement("Update category set catcode=? catdesc=? where catcode = ?");
        query.setString(1,cat.getCatecode());
        query.setString(2,cat.getCatdesc());
    ...
    public void delete(String catcode) throws SQLException, ClassNotFoundException {
        String quer1 = "DELECT FROM Category where catcode = ?";
        PreparedStatement query = con3.connect().prepareStatement(quer1);
    ...
    public void display()throws ClassNotFoundException,SQLException{
        ...
        while(rs.next()){
            ...
            System.out.print("Category code: "+obj1.getCatecode()+" ");
